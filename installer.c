...
int main(int argc, char **argv)
{
  ...
  printf("\nAssurez-vous que les fichiers bootstage/step1 et kernel/step2 soient bien ceux de MBRLoader 2.0-i386.\n");
  ...
  if((l1=fopen("bootstage/step1","r"))==NULL)
    {
      perror("Ouverture de bootstage/step1 en lecture impossible ");
      exit(-2);
    }
  if((l2=fopen("kernel/step2","r"))==NULL)
    {
      perror("Ouverture de kernel/step2 en lecture impossible ");
      exit(-3);
    }
